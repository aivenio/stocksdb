...
**Database Management System | Project `stocksdb` | PostgreSQL**

</div>

<div align = "justify">

This project provides a centralized PostgreSQL database for aggregating stock market data from  *open-source* and 
...
A list of dependent projects that uses the **`stocksdb`** as a base. These projects may/may not be related/owned by the
...
data points for stock market analysis. Certain *non-sensitive* data that is *available in the public domain* may be distributed
